    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground">Τα πλάνα αναβάθμισης θα είναι διαθέσιμα σύντομα.</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <Button variant="outline" disabled>Προσθήκη κάρτας</Button>
          <p className="text-xs text-muted-foreground mt-2">Η διαχείριση πληρωμών θα είναι διαθέσιμη σύντομα.</p>
        </CardContent>
      </Card>
    </div>
  );
