...
export const AI_MODELS: AIModel[] = [
  ...
  // Claude — newest first
  { id: "claude-opus-4-8", name: "Claude Opus 4.8", provider: "anthropic", description: "Most capable" },
  { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", provider: "anthropic", description: "Most efficient" },
  ...
  { id: "google/gemini-3.5-flash", name: "Gemini 3.5 Flash", provider: "google", description: "Fast & capable" },
  { id: "google/gemini-3-flash-preview", name: "Gemini 3 Flash", provider: "google" },
  { id: "google/gemini-3.1-flash-lite-preview", name: "Gemini 3.1 Flash Lite", provider: "google", description: "Cost-efficient" },
  { id: "google/gemini-2.5-pro", name: "Gemini 2.5 Pro", provider: "google" },
  { id: "google/gemini-2.5-flash", name: "Gemini 2.5 Flash", provider: "google" },
  // OpenAI — newest first
  { id: "openai/gpt-5.5", name: "GPT-5.5", provider: "openai", description: "Most capable" },
  { id: "openai/gpt-5.5-pro", name: "GPT-5.5 Pro", provider: "openai", description: "Extended reasoning" },
  { id: "openai/gpt-5.4", name: "GPT-5.4", provider: "openai" },
  { id: "openai/gpt-5.4-mini", name: "GPT-5.4 Mini", provider: "openai" },
  { id: "openai/gpt-5.4-nano", name: "GPT-5.4 Nano", provider: "openai", description: "Fastest" },
