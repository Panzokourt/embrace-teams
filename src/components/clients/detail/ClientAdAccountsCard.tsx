...
import { ExternalLink, BarChart3, Plus } from 'lucide-react';
...
const defaultPlatforms = ['Business Manager', 'Meta Ad Account', 'Google Ads', 'GA4', 'GTM'];

export function ClientAdAccountsCard({ accounts, onEdit }: Props) {
