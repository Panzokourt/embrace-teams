...
export const SignupEmail = ({
  ...
  <Html lang="el" dir="ltr">
    <Head />
    <Preview>Επιβεβαιώστε το email σας στο {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} width="40" height="40" alt={siteName} style={logo} />
        <Heading style={h1}>Επιβεβαίωση email</Heading>
        <Text style={text}>
        ...
        <Text style={footer}>
          Αν δεν δημιουργήσατε λογαριασμό, μπορείτε να αγνοήσετε αυτό το email.
        </Text>
      </Container>
    </Body>
  </Html>
